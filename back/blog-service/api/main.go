...
import (
	...
	"github.com/0x726f6f6b6965/my-blog/blog-service/inernal/client"
	"github.com/0x726f6f6b6965/my-blog/blog-service/inernal/config"
	"github.com/0x726f6f6b6965/my-blog/blog-service/inernal/services"
...
func main() {
	...
	server := services.NewBlogService(db)
	...
	pbBlog.RegisterBlogServiceServer(grpcServer, server)
